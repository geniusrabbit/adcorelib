...
func extractNativeV2Data(req *request.Request, resp *response.Response) defaultData {
	data := defaultData{}
...
func extractNativeV3Data(req *requestV3.Request, resp *response.Response) defaultData {
	data := defaultData{}
	data[adtype.ContentItemLink] = resp.Link.URL
	for _, asset := range resp.Assets {
		if asset.Title != nil {
